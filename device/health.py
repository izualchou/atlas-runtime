...
已从 core/health_checker.py 迁移至 device/health.py（v9.0 架构优化）。
"""
...
from device.detector import PlatformInfo
from models.health import BatteryStatus, MemoryStatus, SystemHealth
